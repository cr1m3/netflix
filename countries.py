...
countries = {'Canada':'CA','United_States':'US', 'Mexico':'MX','France':'FR','Brazil':'BR','United_Kingdom':'UK', 'France':'FR', 'India':'IN', 'Germany':'DE', 'Australia':'AU', 'Italy':'IT','Romania':'RO','Spain':'ES','Turkey':'TR','Czech_Republic':'CZ','Denmark':'DK','Norway':'NO','Indonesia':'ID'}
